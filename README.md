...
- :trophy: I am the owner of the bot Bigotes.
- :technologist: I love using Software as a solution for every `Problem`.
- :computer: I love to learn everything about computers and IT..
- :student: I’m currently learning `JavaScript` and `MySQL`.
- :nerd_face: Always `learning new things`.
- :thinking: I currently develop for myself.
...
<a href="https://www.youtube.com/@gamergys549">
